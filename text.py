...
add_group_folder_text = "Пришлите ссылку на папку для группы."
...
add_group_folder_instruction = "###instruction###"

made_by_text = "Folder_bot: version 1.2.\n\nDesigned and created by @Jakov_Manishek.\nСreated based on the library aiogram 3+.\n\n"\
    "28.10-03.11 выйдет версия folder_bot 3. В этой версии будет полностью переработана концепция хранения файлов и папок (алгоритм графов). "\
    "В этом же диапазоне времени под этой командой появится ссылка на Git проекта."
